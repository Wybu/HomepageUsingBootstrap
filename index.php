	...
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Đăng nhập ngay</a> </li>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="#about" class="effect-3 scroll">VỀ CHÚNG TÔI</a></li>
						<li><a href="#services" class="effect-3 scroll">DỊCH VỤ</a></li>
						<li><a href="#team" class="effect-3 scroll">ĐỘI NGŨ</a></li>
						<li><a href="#gallery" class="effect-3 scroll">THƯ VIỆN</a></li>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="7N1eQBt9zdI" id="video"> <img src="images/banner2.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l">
				<h2>MẪU ĐĂNG KÍ</h2>
				<h4>Nhập vào các thông tin được yêu cầu</h4>
				<form action="#" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="text">Ngày tháng năm sinh:  </li>
							...
							<li class="text">Tên người giám hộ  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="name" type="text" required=""></li>
...
<div class="about-top" id="about">
	<div class="container">
		<h3 class="w3l-title">Về chúng tôi</h3>
		...
		<div class="col-md-5 wthree-about-grids">
			...
			<a href="#mail" class="trend-w3l scroll"><span>Bắt đầu</span></a>
		</div>
		<div class="clearfix"> </div>
	</div>
</div>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">SỐ LƯỢNG HỌC SINH</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">KHÓA HỌC HOÀN THÀNH</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">THÀNH TÍCH ĐẠT ĐƯỢC</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">GIÁO VIÊN</h4>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<h6>01</h6>
				<h5>CƠ HỘI HỌC BỔNG</h5>
				<p>Cơ hội học bổng rất cao.</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>GIẢNG VIÊN ƯU TÚ</h5>
				<p></p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<h6>03</h6>
				<h5>THƯ VIỆN TÀI LIỆU PHONG PHÚ</h5>
				<p></p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
...
<div id="mail" class="contact">
	<div class="container">
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com">quyna.live@example1.com</a>
						<span><a href="mailto:info@example.com">ngoanhquy@example2.com</a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
		...
		<div class="w3l-form">
			<h3 class="w3l-title">Gửi lại thông tin</h3>
			<div class="contact-grid1">
				<div class="contact-top1">
					<form action="#" method="post">
						<div class="col-md-6 col-xs-6 wthree_contact_left_grid">
							<label>Name*</label>
							<input type="text" name="Họ tên" placeholder="Họ tên" required="">
							<label>E-mail*</label>
						...
						<div class="col-md-6 col-xs-6 wthree_contact_left_grid">
							...
							<label>Subject*</label>
							<input type="text" name="Ngành" placeholder="Ngành" required="">
						</div>
						<div class="form-group">
							<label>Message*</label>
							<textarea placeholder name="Nội dung" required=""></textarea>
						</div>
							<input type="submit" value="Gửi">
					</form>
				</div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>Điều Hướng</h4>
				<ul>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="index.html">Trang chủ</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#about" class="scroll">Về chúng tôi</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#services" class="scroll">Dịch vụ</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#team" class="scroll">Đội ngũ</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#gallery" class="scroll">Lưu trữ</a></li>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 w3l-3">
				<h4>Khác</h4>
				<ul>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#">Truyền thông</a></li>
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#">Ứng dụng</a></li>
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(20.963116, 105.792551),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(20.963116, 105.792551),
						map: map,
					});
				}
			</script>
